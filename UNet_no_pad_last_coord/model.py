...
class UNetModel(nn.Module):
    def __init__(self, in_channel_img, in_channel_coord, nclasses, dropout=0.5, use_bn=True, use_dropout=True):
        ...
        contract = CreateConvBlock(in_channel_img, 32, 64, n=2, use_bn=use_bn)
        ...
        self.segmentation = nn.Conv3d(64 + in_channel_coord, nclasses, (1, 1, 1), stride=1, dilation=1, padding=(0, 0, 0))
