...
class UNetModel(nn.Module):
    def __init__(self, in_channel, nclasses, use_bn=True, use_dropout=True, dropout=0.5):
        ...
        #128-128-32 -> 64-64-16
        contract = CreateConvBlock(in_channel, 16, 32, n=2, use_bn=use_bn)
        self.contracts.append(contract)

        # 64-64-16 -> 32-32-16
        contract = CreateConvBlock(32, 32, 64, n=2, use_bn=use_bn)
        self.contracts.append(contract)
        ...
        # 8-8-2 -> 4-4-1
        contract = CreateConvBlock(256, 256, 512, n=2, use_bn=use_bn)
        self.contracts.append(contract)
        ...
        #4-4-1 -> 8-8-2
        expand = CreateUpConvBlock(1024, 512, 512, 512, n=2, use_bn=use_bn)
